...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- Main Content -->
            <main class="px-4 py-4" style="margin-left: 20px;">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            Tổng doanh thu</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo number_format($stats['total_revenue']); ?> VNĐ</div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo number_format($product['sold_quantity']); ?></td>
                                        <td><?php echo number_format($product['revenue']); ?> VNĐ</td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
